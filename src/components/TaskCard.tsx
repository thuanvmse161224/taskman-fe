...
const TaskCard: React.FC<TaskCardProps> = ({ task }) => {
    return (
        <article className="rounded-lg bg-blue-100 p-4 mb-4 min-h-64 flex flex-col justify-between">
            <div>
            ...
            <div>
                <p>Due Date: {getDueDateString(task)}</p>
                <p>Status: {getDueDateStatus(task)}</p>
            </div>
